            ...
            >
                ...
                <div className="bg-white rounded-[2rem] p-10 shadow-xl border border-gray-100">
                    <div className="space-y-2 mb-10">
                        <h1 className="text-2xl font-black text-foreground tracking-tight">Iniciar sesión</h1>
                        <p className="text-muted-foreground font-medium text-sm">Gestiona y optimiza tus currículums.</p>
                    </div>
